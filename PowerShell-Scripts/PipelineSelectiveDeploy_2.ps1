...
$pipelineName = "MoveToProd"    # The name of the pipeline
$stageOrder = 1                 # The order of the source stage. Development (0), Test (1).

$datasetName = ""               # The name of the dataset to be deployed
$reportName = "PushThisReport"  # The name of the report to be deployed
$dashboardName = ""             # The name of the dashboard to be deployed
